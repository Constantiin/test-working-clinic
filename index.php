...
<head>
    ...
    <meta name="description" content="Официальный сайт многопрофильной клиники для детей и взрослых в городе Ростове-на-Дону">
...
<body>
    ...
    <main class="main">
        ...
        <picture class="main__clinic-photo">
            <source srcset="img/clinic.avif" type="image/avif">
            <source srcset="img/clinic.webp" type="image/webp">
            <img src="img/clinic.jpg" alt="Фотография клиники">
        </picture>
